...
- providing a declarative approach to UI design. 
- This separation of UI layout from the application logic helps in maintaining a clear distinction between 
- how the application looks and how it behaves.
...
The integration of UI and controller classes within a single package simplifies the project structure, 
making it easier to navigate and manage related components. This approach ensures that each visual component's functionality 
is closely tied to its appearance, enhancing the cohesiveness and maintainability of the application's user interface.
